function [power_alloc,gmi_snr,lambda_snr,order] = entropyloading_NGMI_weak(NumberOfCarriers,ch_fading,nSpS,SIG,TX,t)
%% 初始化参数
...
filename=['E:\NGMI_exp_data\NGMI_thre_0.92\weak\weak-entropy-loading\tx-lamda-mat\',num2str(t),'.mat'];
