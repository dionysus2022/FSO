function [power_alloc,gmi_snr,lambda_snr,order] = entropyloading(NumberOfCarriers,ch_fading,nSpS,SIG,TX,t)
%% 初始化参数
...
filename=['C:\Users\LZY\Desktop\str\str-entropy-loading\tx-lamda-mat\',num2str(t),'.mat'];
