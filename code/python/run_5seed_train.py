...
"""
run_5seed_train.py
5-seed 训练脚本：seed 2026~2030，每个 seed 训练 weak + strong (cdm_stats 模型)
训练数据: Dataset-A (preprocessed_uniform_qam_rx_lowmem/2026.06.28)
输出: recognition_mrf_lowmem/seed_XXXX/{weak,strong}_cdm_stats/
"""
import os
import sys
import json
...
if len(df_res) > 0:
    ...
    summary_path = os.path.join(BASE_OUT, "5seed_training_summary.csv")
